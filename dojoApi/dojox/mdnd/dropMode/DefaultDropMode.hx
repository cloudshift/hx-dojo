...
public function getDragPoint(coords:Dynamic,size:Dynamic,mousePosition:Dynamic):Void;
public function getTargetArea(areaList:Array<Dynamic>,coords:Dynamic,currentIndexArea:Int):Int;
public function _checkInterval(areaList:Array<Dynamic>,index:Int,x:Dynamic):Bool;
